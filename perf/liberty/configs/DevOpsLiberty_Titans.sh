...
ePassword="UmVncmVzc2lvbjZQQHRyb2w="
...
scp -r ${scriptDir}/sufp/pingperfPingScript.sh ${scriptDir}/sufp/cleanupScripts.sh ${scriptDir}/sufp/pingFirstResponse.sh root@${load_driver}:/sufp/ 
